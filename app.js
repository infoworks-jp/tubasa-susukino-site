...
(()=>{
  ...
  top.insertAdjacentHTML('beforebegin','<section id="videoTop" class="scene hero film-scene video-top"><video class="film-background" autoplay muted loop playsinline preload="metadata" poster="assets/tsubasa-ramen.webp" aria-hidden="true"><source src="https://infoworks-jp.github.io/subasa-new-official/assets/video/tsubasa-top-mobile.mp4" media="(max-width: 700px)" type="video/mp4"><source src="https://infoworks-jp.github.io/subasa-new-official/assets/video/tsubasa-top-pc.mp4" type="video/mp4"></video><div class="film-shade" aria-hidden="true"></div><img class="top-vertical-logo" src="assets/tsubasa-logo.png" alt="味一番つばさ"><div class="hero-copy"><h1>おいしい、<br><em>らーめん。</em></h1></div><div class="top-cm"><button id="openCmPreview" class="cm-open" type="button"><span class="cm-open-mark" aria-hidden="true">▶</span><span>つばさラーメン<br><b>商品CMを見る</b></span><small>音あり・14秒</small></button></div></section>');
