(()=>{
'use strict';
const canvas=document.querySelector('.signature-miso .fx-canvas[data-effect="steam"]');
if(!canvas)return;
const photoAnchor=[910,470];
...
// The simulation must share the product image's coordinate box, not the
// viewport.  Using innerHeight here was the source of the mobile Y drift.
